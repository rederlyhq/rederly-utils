...
export const _reddash = {
    ...
    deepKeysWithoutArrayIndexes: (obj: unknown): string[] => _reddash.removeArrayIndexesFromDeepKeys(_reddash.deepKeys(obj)),
